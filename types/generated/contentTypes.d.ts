...
export interface ApiCityAttractionCityAttraction
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isSuggested: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::city-attraction.city-attraction'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    ...
    socialSharedLinks: Schema.Attribute.Component<'blocks.socials', true>;
...
export interface ApiCraTourCraTour extends Struct.CollectionTypeSchema {
...
export interface ApiCraftTourCraftTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.RichText &
      ...
      >;
    craftRoute: Schema.Attribute.Component<'crafting.routes', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hasOurCities: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
...
export interface ApiCratourAlCratourAl extends Struct.SingleTypeSchema {
  collectionName: 'cratour_als';
  info: {
    displayName: 'Cratour.al';
    pluralName: 'cratour-als';
    singularName: 'cratour-al';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cratour-al.cratour-al'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    service: Schema.Attribute.Component<'service.services', true>;
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['tours', 'transfers', 'hotel', 'car-hire', 'other']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    showOnList: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
...
export interface ApiGroupGroup extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    experiences: Schema.Attribute.Component<'blocks.experience', true>;
    ...
    title: Schema.Attribute.String;
    tourists: Schema.Attribute.Relation<'oneToMany', 'api::tourist.tourist'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTourActivityTourActivity
  extends Struct.CollectionTypeSchema {
...
export interface ApiTourExperienceTourExperience
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tour-experience.tour-experience'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiTourPackageTourPackage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    age: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Age range 4 to 99'>;
    attractions: Schema.Attribute.Relation<
      'oneToMany',
      'api::city-attraction.city-attraction'
    >;
    ...
    groupSize: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'1-50'>;
    highlights: Schema.Attribute.Component<'blocks.highlight', true>;
    isFeatured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    itenerary: Schema.Attribute.Component<'crafting.itenerarr-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tour-package.tour-package'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    routes: Schema.Attribute.Component<'blocks.routes', true>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    slug: Schema.Attribute.UID<'title'>;
    socialSharedLinks: Schema.Attribute.Component<'blocks.socials', true>;
    ...
    totalDays: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiTouristTourist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isLeader: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tourist.tourist'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::city-attraction.city-attraction': ApiCityAttractionCityAttraction;
      'api::cra-tour.cra-tour': ApiCraTourCraTour;
      'api::craft-tour.craft-tour': ApiCraftTourCraftTour;
      'api::cratour-al.cratour-al': ApiCratourAlCratourAl;
      'api::faq.faq': ApiFaqFaq;
      'api::global.global': ApiGlobalGlobal;
      'api::group.group': ApiGroupGroup;
      'api::place.place': ApiPlacePlace;
      'api::tour-activity.tour-activity': ApiTourActivityTourActivity;
      'api::tour-experience.tour-experience': ApiTourExperienceTourExperience;
